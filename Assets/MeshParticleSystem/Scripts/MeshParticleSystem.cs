...
public class MeshParticleSystem : MonoBehaviour
{
    ...
    [SerializeField] ParticleUVPixels[] particleUVPixelsArray;
    UVCoords[] uvCoordsArray;
    ...
    public int AddQuad(Vector3 position, float rotation, Vector3 quadSize, bool isSkewed, int uvIndex)
    {
        ...
        UpdateQuad(quadIndex, position, rotation, quadSize, isSkewed, uvIndex);
    ...
    public void UpdateQuad(int quadIndex, Vector3 position, float rotation, Vector3 quadSize, bool isSkewed, int uvIndex)
    {
        // Relocate vertices
