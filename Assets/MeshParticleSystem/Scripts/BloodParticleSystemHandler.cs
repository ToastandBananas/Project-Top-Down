...
public class BloodParticleSystemHandler : MonoBehaviour {
    ...
    {
        float bloodParticleCount = percentDamage * 10;
    ...
    private class Single {
        ...
        public Single(Vector3 position, Vector3 direction, bool spawnBloodUnderneath, MeshParticleSystem meshParticleSystem)
        {
